 ...
 */
@:native("qx.type.BaseArray")
extern class BaseArray
{
  /**
   ...
   */
   ...
   /**
     ...
     */
    function toArray(): Dynamic; // TODO: type
     ...
     * @return {Array} Returns the modified array (works in place)
     */
    function sort(?compareFunction : haxe.Constraints.Function): Dynamic; // TODO: type
     ...
     */
    function splice(index: Int, howMany: Int, varargs: Rest<Dynamic>): qx.type.BaseArray;
     ...
     */
    function concat(varargs: Dynamic): qx.type.BaseArray;
     ...
     */
    function slice(begin: Int, ?end: Int): qx.type.BaseArray;
     ...
     */
    function indexOf(searchElement: Dynamic, ?fromIndex: Int): Int;
     ...
     * @return {Integer} The index of the given element
     */
    function lastIndexOf(searchElement: Dynamic, ?fromIndex: Int): Int;
     ...
     */
    function forEach(callback: haxe.Constraints.Function, obj: Dynamic): Void;
     ...
     */
    function filter(callback: haxe.Constraints.Function, obj: Dynamic): qx.type.BaseArray;
     ...
     */
    function map(callback: haxe.Constraints.Function, obj: Dynamic): qx.type.BaseArray;
     ...
     */
    function some(callback: haxe.Constraints.Function, obj: Dynamic) : qx.type.BaseArray;
     ...
     */
    function every(callback: haxe.Constraints.Function, obj: Dynamic) : qx.type.BaseArray;
